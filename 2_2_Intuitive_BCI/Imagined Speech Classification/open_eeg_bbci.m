...
cnt = proc_filtButter(cnt, 5, [0.1 125]);
...
for i = 1:length(mrk.pos)
    concat_EEG(:,:,i) = EEG_data(mrk.pos(1,i)-2500:mrk.pos(1,i),:); % time series x channel x trial %% lengh of speech 2000ms but 500ms for bl
end
