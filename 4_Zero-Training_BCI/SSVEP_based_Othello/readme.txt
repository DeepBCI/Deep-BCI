...
URL: https://github.com/skypekitten9/Othello-MiniMax

The external progrem version : 
OpenViBE - ver.2.1.0 , Unity - ver.2020.1.5f1 , Matlab - ver.2015b, 32bit
...
5. start "openvibe-designer", then start in "Othello-MiniMax.exe"