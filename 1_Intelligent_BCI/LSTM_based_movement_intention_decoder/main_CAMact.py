...
if __name__ == '__main__':
    ...
    ed_list1 = ext_files(meta_json["DATA_DIRECTORY"] + BN + '/act1')
    ed_list2 = ext_files(meta_json["DATA_DIRECTORY"] + BN + '/act2')
    ...
    if meta_json["SUBWISE"] is True:
        ...
        for i in range(np.asarray(ed_list1).shape[0]):
            ...
            ep = ext_epochs(meta_json["DATA_DIRECTORY"] + BN + '/act1', ed_list1, i)
            ep2 = ext_epochs(meta_json["DATA_DIRECTORY"] + BN + '/act2', ed_list2, i)
            ...
            lb  = ext_label(meta_json["DATA_DIRECTORY"] + BN + '/act1',ed_list1,i, meta_json["LABEL"])
            lb2 = ext_label(meta_json["DATA_DIRECTORY"] + BN + '/act2',ed_list2,i, meta_json["LABEL"])
        ...
        ep = ext_epochs(meta_json["DATA_DIRECTORY"] + BN + '/act1', ed_list1, 0)
        ep2 = ext_epochs(meta_json["DATA_DIRECTORY"] + BN + '/act2', ed_list2, 0)
        lb = ext_label(meta_json["DATA_DIRECTORY"] + BN + '/act1', ed_list1, 0, meta_json["LABEL"])
        lb2 = ext_label(meta_json["DATA_DIRECTORY"] + BN + '/act2', ed_list2, 0, meta_json["LABEL"])
        ...
        for i in range(np.asarray(ed_list1).shape[0] - 1):
            ...
            ep = np.concatenate((ep, ext_epochs(meta_json["DATA_DIRECTORY"] + BN + '/act1', ed_list1, i + 1)), 2)
            ep2 = np.concatenate((ep2, ext_epochs(meta_json["DATA_DIRECTORY"] + BN + '/act2', ed_list2, i + 1)), 2)
            lb = np.concatenate((lb, ext_label(meta_json["DATA_DIRECTORY"] + BN + '/act1', ed_list1, i+1, meta_json["LABEL"])),0)
            lb2 = np.concatenate((lb2, ext_label(meta_json["DATA_DIRECTORY"] + BN + '/act2', ed_list2, i + 1, meta_json["LABEL"])), 0)
