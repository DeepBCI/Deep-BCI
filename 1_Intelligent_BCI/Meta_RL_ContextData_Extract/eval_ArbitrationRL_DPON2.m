...
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.Q(state_data,action_chosen)]; % session; block; trial; trial_s; goal; active_model; x                                
                            ...
                            if myArbitrator_top.z_spe_flag == 1
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.zspe(end)]; % session; block; trial; trial_s; goal; active_model; SPE
                            else
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; SPE    
                            end
                            data_in{1,ll}.regressor{1,31}.value=[data_in{1,ll}.regressor{1,31}.value vec_reg];
                            ...
                            if myArbitrator_top.z_rpe_flag == 1
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.zrpe(end)]; % session; block; trial; trial_s; goal; active_model; SPE
                            else
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; SPE    
                            end
                            data_in{1,ll}.regressor{1,32}.value=[data_in{1,ll}.regressor{1,32}.value vec_reg];
