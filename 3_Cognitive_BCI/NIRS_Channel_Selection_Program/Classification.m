...
load('D:\Project\2020\NIRS\Channel_selection\20201019\Result\indices.mat');
load('D:\Project\2020\NIRS\Channel_selection\20201019\Result\inner_indice.mat');
load('D:\Project\2020\NIRS\Channel_selection\20201019\Result\Select.mat');
load('D:\Project\2020\NIRS\Channel_selection\20201019\Result\ch.mat');
        ...
        for iter = 1:10
            for fold = 1:5
                ...
                for feat = 1:20
                    ...
                    c_est(feat,sub,fold,iter) = apply_shrinkageLDA_classifier(Trset, sorting(1:3*feat,test), fv.y(1,test));
                end
                clear feat sorting
            end
        end
...
save('D:\Project\2020\NIRS\Channel_selection\20201019\Result\Acc.mat','Acc');
save('D:\Project\2020\NIRS\Channel_selection\20201019\Result\CH_order.mat','CH');