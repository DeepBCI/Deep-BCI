...
for sub=1:15
    ...
    for ch=1:8
        Rear_ch{ch} = bp(1:3750,10+ch,:)-bp(1:3750,9,:);
        Lear_ch{ch} = bp(1:3750,ch,:)-bp(1:3750,19,:);
    end
    for ch=1:3
...
supt = suptitle('SSVEP : Contralateral - filtfilt');
set(supt,'FontSize',18,'FontWeight','bold','Color','k')
set(gcf,'units','normalized','outerposition',[0 0 1 1]);
%%
% cd('D:\NEC lab\Ear-Biosignal\Figure3\SSVEP_all\SSVEP_cont')
...
figure(1),saveas (gcf, 'SSVEP_cont_com.jpg')
figure(2),saveas (gcf, 'SSVEP_cont_ind.jpg')
