...
for sub=1:15
    ...
    stop_data = filter(b,a,rawdata.data);
    [b,a]=butter(n, [0.5 100]/Fn, 'bandpass');
    bp = filter(b,a,stop_data);
    ...
    for ch=1:8
        Rear_ch{ch} = ECEO(1:15050,10+ch,:)-ECEO(1:15050,9,:);
        Lear_ch{ch} = ECEO(1:15050,ch,:)-ECEO(1:15050,19,:);
    end
    for ch=1:3
