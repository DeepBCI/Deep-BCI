...
for sub=1:15
    ...
    for ch=1:8
        Rear_ch{ch} = Hzs(1:3750,10+ch,:)-Hzs(1:3750,19,:);
        Lear_ch{ch} = Hzs(1:3750,ch,:)-Hzs(1:3750,9,:);
    end
...
suptitle('ASSR : Ipsilateral - filtfilt, CF-1000Hz, MF-40Hz')
set(gcf,'units','normalized','outerposition',[0 0 1 1]);

%%
% cd('D:\NEC lab\Ear-Biosignal\Figure3\ASSR\ASSR_ipsil')
...
% figure(1),saveas (gcf, 'ASSR_ipsil_com.jpg')
% figure(2),saveas (gcf, 'ASSR_ipsil_ind.jpg')
% 
