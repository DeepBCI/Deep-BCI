...
for sub=1:15
    ...
    for trial=1:40
        for ch=1:8
            epoch_R{ch}(:,trial) = bp(start2+1+1600*(trial-1):start2+size+1600*(trial-1),10+ch)-bp(start2+1+1600*(trial-1):start2+size+1600*(trial-1),9);
            epoch_L{ch}(:,trial) = bp(start2+1+1600*(trial-1):start2+size+1600*(trial-1),ch)-bp(start2+1+1600*(trial-1):start2+size+1600*(trial-1),19);
        end
