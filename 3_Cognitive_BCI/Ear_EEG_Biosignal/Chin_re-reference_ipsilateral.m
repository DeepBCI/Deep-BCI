...
for sub=1:15
    ...
    % re-reference
    for ch=1:8
        Rear_ch{ch}(:,sub) = bp(start+250:start+15249,10+ch,:)-bp(start+250:start+15249,19,:);
        Lear_ch{ch}(:,sub) = bp(start+250:start+15249,ch,:)-bp(start+250:start+15249,9,:);
    end
...
%%
cd('D:\NEC lab\Ear-Biosignal\Figure\Figure4\Chin_Gavr_2s')
figure(2),saveas (gcf, 'Gavr_ipsil_RMS.jpg')
