...
The defualt networks used in the tool requires Pytorch versions 1.0 and above, as well as Braindecode (Schirrmeister et al., 2018) version 0.4.8 : newer versions are not compaitlbe due to changes to the library.
Note that dependencies may be/have been removed due to copyright concerns, etc..
